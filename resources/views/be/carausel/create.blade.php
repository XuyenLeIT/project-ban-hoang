...
@section('content')
    <div class="container">
        <h2>Carausel Create form</h2>
        <a href="{{ route('carausel.index') }}" class="btn btn-primary">Back to List</a>
        <form enctype="multipart/form-data" action="{{ route('carausel.store') }}" method="POST">
            @csrf
            <div class="mb-3 mt-3">
            ...
            <div class="form-check">
                <input type="radio" class="form-check-input" 
                  {{old("status")== 0?"checked":""}}  id="status_dis" name="status" value="0">
